...
/**
 * Created by liuzhi on 2017/3/26.
 */
public class PBKDFUtil {
     ...
     * 生成密文的长度
     */
    public static final int HASH_BIT_SIZE = 128 * 1;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("1totalMemory=" + totalMemory);
            String salt = PBKDFUtil.generateSalt();
            System.out.println("salt=" + salt);
            String password = PBKDFUtil.getEncryptedPassword("123456", salt);
